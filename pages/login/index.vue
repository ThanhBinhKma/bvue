<template>
  <div class="container-scroller loginPage">
    <div class="container page-body-wrapper full-page-wrapper auth-page">
      <div class="row d-flex align-items-center justify-content-center row-login">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <b-form-group
                  ...
                  :state="state"
                >
                  <b-form-input id="input-1" v-model="formLogin.email" :state="state"></b-form-input>
                </b-form-group>
              </div>
            </div>
            <div class="form-group">
...
export default {
  ...
  computed: {
    ...
    state() {
      return this.formLogin.email.length >= 4 ? true : false
    },
    invalidFeedback() {
      if (this.formLogin.email.length > 4) {
        return ''
      } else if (this.formLogin.email.length > 0) {
